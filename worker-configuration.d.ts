/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c949c2ffe8ad3904879e1405fbab5e11)
// Runtime types generated with workerd@1.20250803.0 2025-08-10 
declare namespace Cloudflare {
	interface Env {
		R2_BUCKET_NAME: "screen-scribe-files";
		R2_ACCESS_KEY_ID: string;
		R2_SECRET_ACCESS_KEY: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		SCREEN_SCRIBE_CONTAINER: DurableObjectNamespace<import("./src/index").MyContainer>;
		SCREEN_SCRIBE: Workflow;
	}
}
